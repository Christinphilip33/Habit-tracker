...
class HabitFlowAPITester:
    def __init__(self, base_url: str = "https://73c52880-87cd-4459-b2f5-2600866de84e.preview.emergentagent.com"):
    ...
    def test_auth_flow(self) -> bool:
        ...
        # Test admin login
        admin_data = {"email": "admin@habitflow.com", "password": "admin123"}
